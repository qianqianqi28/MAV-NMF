%% illustrate min, max volume when data is highly mixed two dimensional data
clear; close all; clc;
cd('D:\MAVNMF\GitHub');
restoredefaultpath
...
alpha=[2; 0.5; 0.5];  % Parameter of the Dirichlet distribution
...
exportgraphics(gcf,'plots/minnomaxdirechlettwo.pdf','ContentType','vector');
