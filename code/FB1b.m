%% illustrate min, max volume when data is highly mixed one dimensional data
clear; close all; clc;
cd('D:\MAVNMF\GitHub');
restoredefaultpath
...
alpha=[2; 2; 0.5];  % Parameter of the Dirichlet distribution
...
exportgraphics(gcf,'plots/minnomaxdirechletone.pdf','ContentType','vector');
